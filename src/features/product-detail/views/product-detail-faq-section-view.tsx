...
const FAQS: FAQ[] = [
    {
        ...
        description: (
            <>
                ...
                >
                    <li>
                        15% off all your orders, including one-time purchases
                    </li>
                    <li>First dibs when sold-out coffees are back in stock</li>
                    <li>Early access to limited-release coffees</li>
                    <li>Freebies and samples throughout your subscription</li>
                </ul>
            </>
        ),
    },
...
export const ProductDetailFAQSectionView = () => {
    return (
