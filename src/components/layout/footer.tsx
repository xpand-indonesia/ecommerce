...
export function Footer() {
  ...
  return (
    <footer className="bg-footer-bg text-dark border-t border-gray-light w-full">
      <div className="max-w-[1440px] mx-auto px-6 py-12 md:py-16 lg:px-[100px] lg:pt-[72px] lg:pb-6 flex flex-col gap-10 md:gap-12">
        {/* Top Newsletter Section */}
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12">
          <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-[48px] lg:leading-[64px] tracking-tight max-w-[608px] text-dark">
        ...
        {/* Separator line */}
        <hr className="border-t border-gray-light w-full" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left text-sm text-gray font-body py-1">
          <span className="font-semibold text-dark">PT EXPANDD</span>
