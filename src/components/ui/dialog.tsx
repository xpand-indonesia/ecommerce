    ...
    return (
        <DialogPortal>
            ...
            >
                {children}
                {showCloseButton && (
                    <DialogClose className="cursor-pointer outline-0 absolute end-4 lg:end-6 top-4 rounded-sm transition-opacity hover:opacity-80 focus:outline-hidden disabled:pointer-events-none">
                        <XCircle className="size-6 text-gary-800" />
...
const DialogHeader = ({
    ...
    <div
        ...
        className={cn('flex flex-col space-y-1 px-4 lg:px-6 py-4', className)}
        {...props}
    />
);
...
function DialogTitle({
    ...
    return (
        <DialogPrimitive.Title
            ...
            className={cn(
                'font-heading text-2xl font-bold leading-[1.333333333] text-gray-800',
                className
            )}
            {...props}
        />
